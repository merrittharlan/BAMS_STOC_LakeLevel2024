...
write.csv(df_out %>% st_drop_geometry(), "out/Glolakes_anomaly_1991_2020BL.csv", row.names = FALSE)
write.csv(combined_data, "out/Glolakes_timeseries_1991_2020BL.csv", row.names = FALSE)